		...
		return (
			<div className="leaderboard">
				...
				<div className="leaderboard__overall-percentage">
					<div className="leaderboard__overall-percentage__circle"><span className="leaderboard__overall-percentage__circle__text">{this.state.overAllPercentage}</span></div>
					<div className="leaderboard__overall-percentage__desc">
						You have more overall scores than <b>{this.state.overAllPercentage}</b> of other participants
					</div>
				</div>
				</div>
				<div className="leaderboard__right">
				<div className="leaderboard__topic-percentage">
					<div className="leaderboard__topic-percentage__circle"><span className="leaderboard__topic-percentage__circle__text">50%</span></div>
					<div className="leaderboard__topic-percentage__desc">
						Still life
					</div>
				</div>
				<div className="leaderboard__topic-percentage">
					<div className="leaderboard__topic-percentage__circle"><span className="leaderboard__topic-percentage__circle__text">21%</span></div>
					<div className="leaderboard__topic-percentage__desc">
						Anatomy
					</div>
				</div>
				...
				{this.props.usersScore &&
				this.props.usersScore.userRank && (
					<h2 className="leaderboard__rank-desc">
						You're ranked <b>{this.props.usersScore.userRank}</b> out of{' '}
						<b>{this.props.usersScore.totalScores}</b> artists for scores earned!{' '}
					</h2>
				)}
			</div>
		);
